...
class awz_tools extends CModule
{
	var $MODULE_ID = "awz.tools";
    var $MODULE_VERSION;
    ...
    public function __construct()
    {
        ...
        $this->MODULE_NAME = Loc::getMessage("AWZ_TOOLS_MODULE_NAME");
        $this->MODULE_DESCRIPTION = Loc::getMessage("AWZ_TOOLS_MODULE_DESCRIPTION");
    ...
    function DoUninstall()
    {
        ...
        if($step < 2) { //выводим предупреждение
            $APPLICATION->IncludeAdminFile(Loc::getMessage('AWZ_TOOLS_INSTALL_TITLE'), $_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/'. $this->MODULE_ID .'/install/unstep.php');
        }
        elseif($step == 2) {
            //проверяем условие
